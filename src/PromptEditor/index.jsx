...
export default function PromptEditor() {
    ...
    const [dirty, setDirty] = useState(false); // visually indicate after restore
    ...
    // Keyboard shortcut: Ctrl/Cmd+S => save version
    useEffect(() => {
        const handler = (e) => {
            const isSave =
    ...
    function onEditContent(next) {
        ...
        // content changed; if user restored earlier, stay dirty until manual save
    }
    ...
    function onRestoreSelected() {
        ...
        setDirty(true); // mark dirty until next manual save
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900">
            ...
            <footer className="mx-auto max-w-7xl px-4 pb-8 pt-2 text-xs text-gray-500">
                <p>
                    Local-only • Data stored in your browser • Version cap {VERSION_CAP}{" "}
